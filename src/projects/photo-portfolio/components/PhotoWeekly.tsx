...
import WP_12_Th from "../../../assets/photo_portfolio/WP/Thumbnails/ChenF_WP_12_Thumbnail.jpg"
...
const WeeklyPhoto: React.FC<PropsWithChildren<WeeklyPhotoProps>> = ({ photo, title, children, thumbnail}) => {
    return (
        <div className={"w-[24.775vw] h-[25vh] relative"}>
            ...
            <Photo
                ...
                title={title}
                thumbnail={thumbnail ? thumbnail : photo} // use thumbnail if provided, else use full photo
            >
                {children}
            </Photo>
        </div>
    ...
    return (
        <div>
            ...
            <div className="min-w-[99vw] items-center grid grid-cols-4">
                <WeeklyPhoto photo={WP_1} title="WP1: My Life" thumbnail={WP_1_Th}>
                ...
                <WeeklyPhoto photo={WP_3} title="WP3: Frame in Frame" thumbnail={WP_3_Th}>
                ...
                <WeeklyPhoto photo={WP_5} title="WP5: Reflections" thumbnail={WP_5_Th}>
                ...
                <WeeklyPhoto photo={WP_6} title="WP6: Entropy" thumbnail={WP_6_Th}>
                ...
                <WeeklyPhoto photo={WP_7} title="WP7: Light and Shadow" thumbnail={WP_7_Th}>
                ...
                <WeeklyPhoto photo={WP_9} title="WP9: Natural Elements" thumbnail={WP_9_Th}>
                ...
                <WeeklyPhoto photo={WP_10} title="WP10: Nostalgia" thumbnail={WP_10_Th}>
                ...
                <WeeklyPhoto photo={WP_11_12} title="WP11 & WP12" thumbnail={WP_12_Th}>
                    <div>
                ...
                <WeeklyPhoto photo={WP_13} title="WP13: Endings" thumbnail={WP_13_Th}>
